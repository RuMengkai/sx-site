...
<body>
    <form enctype="multipart/form-data" id="PostMe" action="?" method="post" name="upform">
        ...
        <div class="uploadpic">
		<img id="ImgPr" src="<?php if($Img == ''): ?>/tp9_1/Public/qwadmin/images/nopic.gif<?php else: ?>/tp9_1<?php echo ($Img); endif; ?>"  width="<?php echo ($Width); ?>" height="<?php echo ($Height); ?>">
        <div class="uploadtext">点击上传</div>
