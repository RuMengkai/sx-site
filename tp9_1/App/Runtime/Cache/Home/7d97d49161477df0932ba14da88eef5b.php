						...
						<div class="col-xs-12">
							...
							<div class="row">
								<form id="form" method="post" action="<?php echo U('del');?>">
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<?php if($username == 'sxujob'): ?><th class="center">操作</th><?php endif; ?>
												<?php if($username == 'sxucypx'): ?><th class="center">操作</th><?php endif; ?>
											</tr>
										</thead>
										<tbody>
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr id="del<?php echo ($val["id"]); ?>"  <?php if($val['ding'] == 1): ?>bgcolor="#FFFFEC"<?php endif; ?>>
													...
													<?php if($username == 'sxujob'): ?><td class="center">
															<?php if($val['ding'] != 1): ?><a href="javascript:;" onclick="ding(<?php echo ($val["id"]); ?>,1)">置顶</a>
															<?php else: ?>
																<a href="javascript:;" onclick="ding(<?php echo ($val["id"]); ?>,0)">取消</a><?php endif; ?>&nbsp;&nbsp;

																<a href="<?php echo U('Sign/sedit');?>?id=<?php echo ($val["id"]); ?>">修改</a>&nbsp;&nbsp;
															
															<a href="javascript:;" onclick="del(<?php echo ($val["id"]); ?>)">删除</a>
														</td><?php endif; ?>
													<?php if($username == 'sxucypx'): ?><td class="center">
															<?php if($val['ding'] != 1): ?><a href="javascript:;" onclick="ding(<?php echo ($val["id"]); ?>,1)">置顶</a>
															<?php else: ?>
																<a href="javascript:;" onclick="ding(<?php echo ($val["id"]); ?>,0)">取消</a><?php endif; ?>&nbsp;&nbsp;
															<a href="<?php echo U('Sign/sedit');?>?id=<?php echo ($val["id"]); ?>">修改</a>&nbsp;&nbsp;
									...
									<?php if($val["id"] == ""): ?><tr>暂无发布的课程</tr><?php endif; ?>
								</form>
								<?php echo ($page); ?>
							</div>
