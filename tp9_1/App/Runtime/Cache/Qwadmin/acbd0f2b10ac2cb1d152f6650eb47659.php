	...
	<!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" id="form" method="post" action="<?php echo U('update_score');?>">
									<input type="hidden" name="id" value="<?php echo ($score["id"]); ?>" id="id" />

									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 积分名称 </label>
										<div class="col-sm-9">
											<input type="text" readonly name="name" id="name" placeholder="积分名称" class="col-xs-10 col-sm-5" value="<?php echo ($score['name']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">积分名称不能修改。</span>
											</span>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-3"> 积分描述 </label>
										<div class="col-sm-9">
											<textarea name="desc" id="desc" placeholder="积分描述 " class="col-xs-10 col-sm-5" rows="5"><?php echo ($score['desc']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">积分描述。 </span>
											</span>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 分值</label>
										<div class="col-sm-9">
											<input type="text" name="score" id="score" placeholder="分值" class="col-xs-10 col-sm-5" value="<?php echo ($score['score']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"> 分值。</span>
											</span>
										</div>
									</div>
