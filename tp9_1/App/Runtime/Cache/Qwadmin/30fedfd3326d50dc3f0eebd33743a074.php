					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?php if( $user["head"] == '' ): ?>/tp9_1/Public/qwadmin/avatars/avatar2.png<?php else: ?>/tp9_1<?php echo ($user["head"]); endif; ?>" alt="<?php echo ($user["user"]); ?>" />
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<select id="type" name="type" class="col-xs-10 col-sm-5">
											<option value="0" <?php if($currentcategory['type'] == 0): ?>selected="selected"<?php endif; ?>>普通栏目</option>
											<option value="1" <?php if($currentcategory['type'] == 1): ?>selected="selected"<?php endif; ?>>单页栏目</option>
											<option value="2" <?php if($currentcategory['type'] == 2): ?>selected="selected"<?php endif; ?>>外链栏目</option>
										</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name" placeholder="分类名称" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["name"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> SEO标题 </label>
										<div class="col-sm-9">
											<input type="text" name="seotitle" id="seotitle" placeholder="SEO标题" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["seotitle"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="keywords" id="keywords" placeholder="关键词" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["keywords"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="description" id="description" placeholder="栏目描述" class="col-xs-10 col-sm-5" rows="5"><?php echo ($currentcategory["description"]); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="url" id="url" placeholder="外链地址" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["url"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="cattemplate" id="cattemplate" placeholder="分类模板" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["cattemplate"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="contemplate" id="contemplate" placeholder="内容模板" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["contemplate"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="o" id="o" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($currentcategory["o"]); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
