							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name" placeholder="积分名称" class="col-xs-10 col-sm-5" value="<?php echo ($score['name']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">积分名称不能为空。</span>
											</span>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="score" id="score" placeholder="分值" class="col-xs-10 col-sm-5" value="<?php echo ($message['user']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
