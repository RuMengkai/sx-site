						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-7"> 积分 </label>
										<div class="col-sm-9">
											<input type="text" name="score" id="score" placeholder="score" class="col-xs-10 col-sm-5" value="<?php echo ($member['score']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
...
<![endif]-->
		...
		<script src="/tp9_1/Public/qwadmin/js/date-time/bootstrap-datepicker.js"></script>
		<script src="/tp9_1/Public/qwadmin/js/function.js"></script>
		<script type="text/javascript">
		jQuery(function($){
			$('#birthday').datepicker({
				  format: 'yyyy-mm-dd',
