							...
							<div class="col-xs-12">
								...
								<div class="space-4"></div>
									<form id="form" method="post" action="<?php echo U('del');?>">
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr class="fist_btn" value="<?php echo ($val['id']); ?>">
												<td class="center">
											...
											<?php if(!empty($val["children"])): if(is_array($val["children"])): $i = 0; $__LIST__ = $val["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="<?php echo ($v['pid']); ?>" style="display: none;">
													<td class="center">
												...
												<?php if(!empty($v["children"])): if(is_array($v["children"])): $i = 0; $__LIST__ = $v["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr class="<?php echo ($v['pid']); ?>" style="display: none;">
														<td class="center">
