						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<input type="hidden" name="mid" value="<?php echo ($article["mid"]); ?>" id="mid" />

									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 留言标题 </label>
										<div class="col-sm-9">
											<input type="text" name="title" id="title" placeholder="留言标题" class="col-xs-10 col-sm-5" value="<?php echo ($message['title']); ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="seotitle" id="seotitle" placeholder="SEO标题" class="col-xs-10 col-sm-5" value="<?php echo ($message['title']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-3"> 留言 </label>
										<div class="col-sm-9">
											<textarea name="content" id="content" placeholder="留言内容" class="col-xs-10 col-sm-5" rows="5"><?php echo ($message['content']); ?></textarea>
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">留言内容</span>
											</span>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 作者 </label>
										<div class="col-sm-9">
											<input type="text" name="user" id="user" placeholder="作者" class="col-xs-10 col-sm-5" value="<?php echo ($message['user']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">作者。</span>
											</span>
										</div>
									</div>
