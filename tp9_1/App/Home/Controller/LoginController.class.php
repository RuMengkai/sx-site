...
class LoginController extends BaseController {
    public function index(){
		...
		/*$token ="502947e9cb8b7c7250e6985036e019ed";
		$salt = "3zyncNMGJk";//random(10);
		$identifier="19451ea1be79444b36a51b9ab17e26fd";
		...
		if (ctype_alnum($identifier) && ctype_alnum($token)) {
			$user = M('member')->field('uid,user,desc,identifier,token,salt')->where(array('identifier'=>$identifier))->find();
			if($user) {
